...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section
      ref={sectionRef}
      id="hero"
      className="relative w-full h-[88vh] hero-aspect-responsive sm:h-[88vh] md:h-[110vh] min-h-[520px] sm:min-h-[650px] md:min-h-[750px] md:max-h-[1400px] overflow-hidden bg-[#0A0A0A] select-none"
    >
      ...
      <div
        ref={headlineRef}
        className="absolute top-[23%] sm:top-[16%] md:top-[18%] left-1/2 -translate-x-1/2 z-[10] pointer-events-none w-full text-center px-2 sm:px-4 will-change-transform"
      >
      ...
      {/* LAYER 5: Bodybuilder Figure Cutout (Calibrated for all screen widths below 768px including 709px) */}
      <div
        ref={figureRef}
        className="absolute bottom-0 left-1/2 -translate-x-1/2 z-[20] w-full max-w-5xl md:max-w-7xl h-[72vh] sm:h-[72vh] md:h-[84vh] flex justify-center items-end pointer-events-none will-change-transform"
      >
        <div className="relative w-full h-full transform scale-[1.28] sm:scale-[1.14] md:scale-120 origin-bottom">
          <Image
      ...
      <div className="absolute inset-0 z-[30] pointer-events-none">
        ...
        <div className="absolute left-1/2 -mt-2 sm:mt-0 -translate-x-1/2 top-[84%] sm:top-[88%] md:top-[89%] flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 pointer-events-auto w-full px-3">
          <button
